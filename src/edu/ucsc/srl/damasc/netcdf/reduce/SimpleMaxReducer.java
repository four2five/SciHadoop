...
/**
 * A reducer that applies the maximum function. Uses a simple data structure
 * as its key
 */
public class SimpleMaxReducer extends 
        Reducer<LongWritable, IntWritable, GroupID, IntWritable> {

  private static final Log LOG = LogFactory.getLog(SimpleMaxReducer.class);
